...
TIP: These configurations are inherited to your repositories. You might have the [user] here too, if you have the same login/password for all your repositories
...
* On Commit message 
** Click on amend if you want to amend a commit already started
