...
image::geek-and-poke-dont-update.jpg[{half-width}]
...
image::turnoff-what-your-code-looks-like.png[{half-width}]
...
image::git-messages.png[{half-width}]
...
.Peer review is better than peer refactoring
