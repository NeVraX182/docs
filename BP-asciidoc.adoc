...
* icon:file-text-o[link=sample/{docname}.adoc] Source
* icon:globe[link={sample/docname}.html] Html
* Slides (Reveal.js)
** icon:video-camera[link=sample/PRES-{docname}-dark.html] dark
** icon:video-camera[link=sample/PRES-{docname}-light-parallax.html] light on parallax
* icon:file-pdf-o[link=sample/{docname}.pdf] PDF
